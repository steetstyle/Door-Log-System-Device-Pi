...
class CardReader(object):
	...
	def registerReader(self, edge = RPIO.FALLING, pull_up_down=RPIO.PUD_OFF):
		RPIO.setup(self.GPIO_0, RPIO.IN, pull_up_down)
		RPIO.setup(self.GPIO_1, RPIO.IN, pull_up_down)
